...
if __name__ == "__main__":
    ...
    def train_clf(df):
        vectorizer = text.Vectorizer('tfidf').get(numFeatures=NUM_FEATURES, inputCol=WORDS_OUTPUT_COL
                                                  , outputCol=VECTOR_INDEX_COL)
        ...
        return vecModel, idxModel, clfModel
    ...
    def save_model(vecModel,idxModel,clfModel):
    ...
    vecModel, idxModel, clfModel = train_clf(tokenTrainDF)

    if DO_SAVE: save_model(vecModel,idxModel,clfModel)
